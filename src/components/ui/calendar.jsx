...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background w-full group/calendar p-3 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        button_previous: cn(
          "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none rounded-lg hover:bg-gray-100",
